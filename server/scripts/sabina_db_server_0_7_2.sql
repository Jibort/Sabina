-- SERVER DATABASE 0.7.2 ======================================================
-- mariadb --user=oper --password=Oper81Dev23 sabina
-- source D:\psicodex\sabina\db\server\sabina_db_server_0_7_2.sql
-- mariadb --user=oper --password=Oper81Dev23 < sabina_db_server_0_7_2.sql
...
-- USER AREA ==================================================================
-- USRMOD (1ra part)===================
-- usr_user.dart (CoreEntityType.both)
CREATE TABLE USER (
...
-- usr_device.dart (CoreEntityType.both)
CREATE TABLE DEVICE (
    ID         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    CREATED_BY INT UNSIGNED NOT NULL REFERENCES USER(ID),
    CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- usr_fcm_history.dart (CoreEntityType.both)
...
-- LOCALIZATION AREA ==========================================================
-- LOCMOD =============================
-- loc_translation.dart (CoreEntityType.none)
...
-- LSTMOD =============================
-- lst_list_category.dart (CoreEntityType.both)
...
-- lst_option_list.dart (CoreEntityType.both)
...
-- lst_option_entry.dart (CoreEntityType.both)
...
-- DISMOD =============================
-- DSM-V ------------------------------
-- dis_dsm_v.dart (CoreEntityType.none)
CREATE TABLE DSM_V (
    ID INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
-- DISEASE ----------------------------
-- dis_disease.dart (CoreEntityType.both)
...
-- PHASE ------------------------------
-- dis_phase.dart (CoreEntityType.both)
CREATE TABLE PHASE (
    ID         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    CREATED_BY INT UNSIGNED NOT NULL REFERENCES USER(ID),
    CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- GOAL -------------------------------
-- dis_goal.dart (CoreEntityType.both)
CREATE TABLE GOAL (
    ID         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    CREATED_BY INT UNSIGNED NOT NULL REFERENCES USER(ID),
    CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- RESMOD =============================
-- PHASE RESOURCE ---------------------
-- res_resource.dart (CoreEntityType.both)
...
-- res_phase_resource.dart (CoreEntityType.both)
...
-- TCKMOD =============================
-- TRACKING ---------------------------
-- tck_tracking.dart (CoreEntityType.both)
...
-- PHASE TRACKING ---------------------
-- tck_phase_tracking.dart (CoreEntityType.both)
...
-- TRACKING COLUMN --------------------
-- tck_tracking_column.dart (CoreEntityType.both)
...
-- TSTMOD =============================
-- TRACKING ---------------------------
-- tst_category.dart (CoreEntityType.both)
...
-- TEST -------------------------------
-- tst_test.dart (CoreEntityType.both)
CREATE TABLE TEST (
    ID         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    CREATED_BY INT UNSIGNED NOT NULL REFERENCES USER(ID),
    CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- QUESTION ---------------------------
-- tst_question.dart (CoreEntityType.both)
...
-- EMOMOD =============================
-- MOOD -------------------------------
-- emo_mood.dart (CoreEntityType.both)
CREATE TABLE MOOD (
    ID         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    CREATED_BY INT UNSIGNED NOT NULL REFERENCES USER(ID),
    CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- EMOTION ----------------------------
-- emo_emotion.dart (CoreEntityType.both)
...
-- VISMOD =============================
-- VISIT ------------------------------
-- vis_visit.dart (CoreEntityType.both)
CREATE TABLE VISIT (
    ID         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    CREATED_BY INT UNSIGNED NOT NULL REFERENCES USER(ID),
    CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- DGNMOD =============================
-- DIAGNOSIS --------------------------
-- dgn_diagnosis.dart (CoreEntityType.both)
...
-- DIAGNOSIS PHASE --------------------
-- dgn_diagnosis_phase.dart (CoreEntityType.both)
...
-- ACHIEVEMENT ------------------------
-- dgn_achievement.dart (CoreEntityType.both)
...
-- MATMOD =============================
-- MATERIAL ---------------------------
-- mat_material.dart (CoreEntityType.both)
...
-- PHASE MATERIAL ---------------------
-- mat_phase_material.dart (CoreEntityType.both)
...
-- REGMOD =============================
-- REGISTER ---------------------------
-- reg_register.dart (CoreEntityType.both)
...
-- REGISTER COLUMN --------------------
-- reg_register_column.dart (CoreEntityType.both)
...
-- RESMOD =============================
-- PATIENT TEST -----------------------
-- res_patient_test.dart (CoreEntityType.both)
...
-- ANSWER -----------------------------
-- res_answer.dart (CoreEntityType.both)
CREATE TABLE ANSWER (
    ID         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    CREATED_BY INT UNSIGNED NOT NULL REFERENCES USER(ID),
    CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    PATIENT_TEST_ID INT UNSIGNED NOT NULL REFERENCES PATIENT_TEST(ID),
    QUESTION_ID     INT UNSIGNED NOT NULL REFERENCES QUESTION(ID),
    ANSWER          VARCHAR(2048),
    OPTION_ENTRY_ID INT UNSIGNED REFERENCES OPTION_ENTRY(ID),
    EMOTION_ID      INT UNSIGNED REFERENCES EMOTION(ID),
    MOOD_ID         INT UNSIGNED REFERENCES MOOD(ID),
    COMPLETED_AT    DATETIME,
    EVALUATED_BY    INT UNSIGNED REFERENCES USER(ID),
...
-- TSKMOD =============================
-- TASK -------------------------------
-- tsk_task.dart (CoreEntityType.both)
CREATE TABLE TASK (
    ID         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    CREATED_BY INT UNSIGNED NOT NULL REFERENCES USER(ID),
    CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- NTFMOD =============================
-- NOTIFICATION -----------------------
-- ntf_notification.dart (CoreEntityType.both)
...
set @mood_desesperationid = "#MOOD_DESPERATION";
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_ANGER");
set @mood_angerid = "#MOOD_ANGER";
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_ANXIETY");
set @mood_anxietyid = "#MOOD_ANXIETY";
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_INSECURITY");
set @mood_insecurityid = "#MOOD_INSECURITY";
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_SADNESS");
set @mood_sadnessid = "#MOOD_SADNESS";
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_BOREDOM");
set @mood_boredomid = "#MOOD_BOREDOM";
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_INDIFFERENCE");
set @mood_indifferenceid = "#MOOD_CALM";
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_CALM");
set @mood_calmid = LAST_INSERT_ID();
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_HAPPINESS");
set @mood_happinessid = "#MOOD_HAPPINESS";
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#MOOD_GRATITUDE");
set @mood_gratitudeid = "#MOOD_GRATITUDE";
INSERT INTO TRANSLATION (LOCALE_CODE, TEXT_KEY, LITERAL)
VALUES(
        @loc_esid,
...
set @emo_anger_id = "#1_EMOTION_ANGER";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_hate_id = "#1_1_EMOTION_HATE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_outraged_id = "#1_1_1_EMOTION_OTRAGED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_resentful_id = "#1_1_2_EMOTION_RESENTFUL";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_madness_id = "#1_2_EMOTION_MADNESS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_angry_id = "#1_2_1_EMOTION_ANGRY";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_madness_id = "#1_2_2_EMOTION_MADNESS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_aggression_id = "#1_3_EMOTION_AGGRESSION";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_hostile_id = "#1_3_1_EMOTION_HOSTILE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_provocateur_id = "#1_3_2_EMOTION_PROVOCATEUR";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_injured_id = "#1_4_EMOTION_INJURED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_devastated_id = "#1_4_1_EMOTION_DEVASTATED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_distressed_id = "#1_4_2_EMOTION_DISTRESSED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_threatened_id = "#1_5_EMOTION_THREATENED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_attacked_id = "#1_5_1_EMOTION_ATTACKED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_jealous_id = "#1_5_2_EMOTION_JEALOUS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_frustrated_id = "#1_6_EMOTION_FRUSTRATED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_enraged_id = "#1_6_1_EMOTION_ENRAGED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_irritated_id = "#1_6_2_EMOTION_IRRITATED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_critic_id = "#1_7_EMOTION_CRITIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_sarcastic_id = "#1_7_1_EMOTION_SARCASTIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_skeptic_id = "#1_7_2_EMOTION_SKEPTIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_distant_id = "#1_8_EMOTION_DISTANT";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_distrustful_id = "#1_8_1_EMOTION_DISTRUSTFUL";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#1_8_2_EMOTION_INTROVERT");
set @emo_introvert_id = "#1_8_2_EMOTION_INTROVERT";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_disgust_id = "#2_EMOTION_DISGUST";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_disappointed_id = "#2_1_EMOTION_DISAPPOINTED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
VALUES(@emo_disappointed_id, @parent_level_1, 0, 1);
set @parent_level_2 = LAST_INSERT_ID();
INSERT INTO TRANSLATION (LOCALE_CODE, TEXT_KEY, LITERAL)
VALUES(@loc_esid, @emo_disappointed_id, "Decepcionado/a"),
...
set @emo_disgusting_id = "#2_1_1_EMOTION_DISGUSTING";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_unruly_id = "#2_1_2_EMOTION_UNRULY";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_dissatisfied_id = "#2_2_EMOTION_DISSATISFIED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_moralist_id = "#2_2_1_EMOTION_MORALIST";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_reluctant_id = "#2_2_2_EMOTION_RELUCTANT";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_abstinent_id = "#2_3_EMOTION_ABSTINENT";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_dislike_id = "#2_3_1_EMOTION_DISLIKE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_hesitant_id = "#2_3_2_EMOTION_HESITANT";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_horrible_id = "#2_4_EMOTION_HORRIBLE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_hateful_id = "#2_4_1_EMOTION_HATEFUL";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_disgusted_id = "#2_4_2_EMOTION_DISGUSTED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_fear_id = "#3_EMOTION_FEAR";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_humiliated_id = "#3_1_EMOTION_HUMILIATED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_ridiculed_id = "#3_1_1_EMOTION_RIDICULE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_disrespected_id = "#3_1_2_EMOTION_DISRESPECTED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_rejected_id = "#3_2_EMOTION_REJECTED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_marginalized_id = "#3_2_1_EMOTION_MARGINALIZED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_alienated_id = "#3_2_2_EMOTION_ALIENATED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_scared_id = "#3_3_EMOTION_SCARED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_terrified_id = "#3_3_1_EMOTION_TERRIFIED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_frightened_id = "#3_3_2_EMOTION_FRIGHTENED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_fearful_id = "#3_3_3_EMOTION_FEARFUL";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_anxious_id = "#3_4_EMOTION_ANXIOUS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_overwhelmed_id = "#3_4_1_EMOTION_OVERWHELMED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_concerned_id = "#3_4_2_EMOTION_CONCERNED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_submissive_id = "#3_5_EMOTION_SUBMISSIVE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_Useless_id = "#3_5_1_EMOTION_USELESS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_negligible_id = "#3_5_2_EMOTION_NEGLIGIBLE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_insecure_id = "#3_6_EMOTION_INSECURE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_inferior_id = "#3_6_1_EMOTION_INFERIOR";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_insufficient_id = "#3_6_2_EMOTION_INSUFFICIENT";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_sadness_id = "#4_EMOTION_SADNESS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_desperate_id = "#4_1_EMOTION_DESPERATE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_helpless_id = "#4_1_1_EMOTION_HELPLESS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_vulnerable_id = "#4_1_2_EMOTION_VULNERABLE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_depressed_id = "#4_2_EMOTION_DEPRESSED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_empty_id = "#4_2_1_EMOTION_EMPTY";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_melancholic_id = "#4_2_2_EMOTION_MELANCHOLIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_guilty_id = "#4_3_EMOTION_GUILTY";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_ashamed_id = "#4_3_1_EMOTION_ASHAMED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_regretful_id = "#4_3_2_EMOTION_REGRETFUL";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_abandoned_id = "#4_4_EMOTION_ABANDONED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_ignored_id = "#4_4_1_EMOTION_IGNORED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_victimized_id = "#4_4_2_EMOTION_VICTIMIZED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_alone_id = "#4_5_EMOTION_ALONE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_homeless_id = "#4_5_1_EMOTION_HOMELESS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_isolated_id = "#4_5_2_EMOTION_ISOLATED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_bored_id = "#4_6_EMOTION_BORED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_apathetic_id = "#4_6_1_EMOTION_APATHETIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
VALUES(@emo_sarcastic_id, @parent_level_2, 0, 1);
INSERT INTO TRANSLATION (LOCALE_CODE, TEXT_KEY, LITERAL)
...
set @emo_indifferent_id = "#4_6_2_EMOTION_INDIFFERENT";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_surprise_id = "#5_EMOTION_SUPRISE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_confused_id = "#5_1_EMOTION_CONFUSED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_disillusioned_id = "#5_1_1_EMOTION_DISILLUSIONED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
VALUES(@emo_disillusioned_id, @parent_level_2, 0, 1);
INSERT INTO TRANSLATION (LOCALE_CODE, TEXT_KEY, LITERAL)
VALUES(@loc_esid, @emo_disillusioned_id, "Desilusionado/a"),
    (@loc_caid, @emo_disillusioned_id, "Desil·lusionat/da"),
    (@loc_enid, @emo_disillusioned_id, "Disillusioned"),
    (@loc_frid, @emo_disillusioned_id, "Désillusionné"),
    (@loc_ptid, @emo_disillusioned_id, "Desiludido");
-- 5.1.2 Perplex/a
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#5_1_2_EMOTION_PERPLEXED");
set @emo_perplexed_id = "#5_1_2_EMOTION_PERPLEXED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_surprised_id = "#5_2_EMOTION_SURPRISED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_dejected_id = "#5_2_1_EMOTION_DEJECTED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_shocked_id = "#5_2_2_EMOTION_SHOCKED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_astonished_id = "#5_3_EMOTION_ASTONISHED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_stupefied_id = "#5_3_1_EMOTION_STUPEFIED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_impressed_id = "#5_3_2_EMOTION_IMPRESSED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_enthusiastic_id = "#5_4_EMOTION_ENTHUSIASTIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
VALUES(@emo_enthusiastic_id, @parent_level_1, 0, 1);
set @parent_level_2 = LAST_INSERT_ID();
INSERT INTO TRANSLATION (LOCALE_CODE, TEXT_KEY, LITERAL)
VALUES(@loc_esid, @emo_enthusiastic_id, "Entusiasmado/a"),
    (@loc_caid, @emo_enthusiastic_id, "Entusiasmat/da"),
    (@loc_enid, @emo_enthusiastic_id, "Enthusiastic"),
    (@loc_frid, @emo_enthusiastic_id, "Excité"),
    (@loc_ptid, @emo_enthusiastic_id, "Entusiasmado");
-- 5.4.1 Entusiasta
-- INSERT INTO TEXT_KEY (TEXT_KEY)
-- VALUES ("#5_4_1_EMOTION_ENTHUSIAST");
set @emo_enthusiast_id = "#5_4_1_EMOTION_ENTHUSIAST";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_energetic_id = "#5_4_2_EMOTION_ENERGETIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_happiness_id = "#6_EMOTION_HAPPINESS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_interested_id = "#6_1_EMOTION_INTERESTED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_curious_id = "#6_1_2_EMOTION_CURIOUS";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_calm_id = "#6_2_EMOTION_CALM";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_sensitive_id = "#6_2_1_EMOTION_SENSITIVE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_prankster_id = "#6_2_2_EMOTION_PRANKSTER";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_accepted_id = "#6_3_EMOTION_ACCEPTED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_respected_id = "#6_3_1_EMOTION_RESPECTED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_satisfied_id = "#6_3_2_EMOTION_SATISFIED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_pacific_id = "#6_4_EMOTION_PACIFIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_affectionate_id = "#6_4_1_EMOTION_AFFECTIONATE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_hopeful_id = "#6_4_2_EMOTION_HOPEFUL";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_optimistic_id = "#6_5_EMOTION_OPTIMISTIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_open_id = "#6_5_1_EMOTION_OPEN";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_inspired_id = "#6_5_2_EMOTION_INSPIRED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_cheerful_id = "#6_6_EMOTION_CHEERFUL";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_released_id = "#6_6_1_EMOTION_RELEASED";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_euphoric_id = "#6_6_2_EMOTION_EUPHORIC";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_proud_id = "#6_7_EMOTION_PROUD";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_important_id = "#6_7_1_EMOTION_IMPORTANT";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_insurance_id = "#6_7_2_EMOTION_INSURANCE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_powerful_id = "#6_8_EMOTION_POWERFUL";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_brave_id = "#6_8_1_EMOTION_BRAVE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)
...
set @emo_provocative_id = "#6_8_2_EMOTION_PROVOCATIVE";
INSERT INTO EMOTION (NAME_KEY, PARENT_ID, VALUE, CREATED_BY)

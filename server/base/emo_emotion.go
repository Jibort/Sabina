...
// CONSTRUCTORS ---------------------------
func (*EmoEmotion) New(pBase *GoBaseEntity, pName *LocTranslation, pDesc *LocTranslation, pParent *EmoEmotion, pValue int32) *EmoEmotion {
	return &EmoEmotion{
		Entity:      *pBase,
		Name:        *pName,
		Description: pDesc,
...
func (*EmoEmotion) ByProto(pEmotion *proto.EmoEmotion, pLang string) (rEnt *EmoEmotion, rErr error) {
	...
	if base, rErr = (*GoBaseEntity).ByProto(nil, pEmotion.BaseEntity, pLang); rErr != nil {
		return
	}
...
func (cEmo *EmoEmotion) ToProto(pLang any) (rEmo *proto.EmoEmotion, rErr error) {
	if cEmo.Entity.ServerId == nil {
		rErr = ErrorNullId("EmoEmotion.ToProto()")
	} else {
...
func (*EmoEmotion) version() *Version {
...
func (*EmoEmotion) FromSqlRow(pRows *sql.Rows, pId uint32, pMandatory bool, pLang any) (rEmo *EmoEmotion, rErr error) {
	...
	if pRows.Next() {
		...
		if rErr = pRows.Scan(
			...
			rEmo = nil
			if pMandatory {
				rErr = ErrorInstanceForIdNotFound("EmoEmotion.FromSqlRow()", pId, rErr)
			}
			return
		}

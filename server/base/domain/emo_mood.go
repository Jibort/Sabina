// Fitxer de definició proto per l'entitat EmoMood.
package domain
...
// CONSTRUCTORS ---------------------------
func (*EmoMood) New(pBase *BaseEntity, pName *LocTranslation, pDesc *LocTranslation, pValue int32) *EmoMood {
	return &EmoMood{
		Entity:      *pBase,
		Name:        *pName,
		Description: pDesc,
...
func (*EmoMood) ByProto(pMood *proto.EmoMood, pLang any) (rEnt *EmoMood, rErr error) {
	...
	var base *BaseEntity
	if base, rErr = (*BaseEntity).ByProto(nil, pMood.BaseEntity, pLang); rErr != nil {
		return
	}

...
const (
	LanguageService_Translate_FullMethodName = "/proto.LanguageService/Translate"
)
...
type LanguageServiceClient interface {
	Translate(ctx context.Context, in *LocReqtTranslate, opts ...grpc.CallOption) (*LocRespTranslate, error)
}
...
func (c *languageServiceClient) Translate(ctx context.Context, in *LocReqtTranslate, opts ...grpc.CallOption) (*LocRespTranslate, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LocRespTranslate)
...
type LanguageServiceServer interface {
	Translate(context.Context, *LocReqtTranslate) (*LocRespTranslate, error)
...
func (UnimplementedLanguageServiceServer) Translate(context.Context, *LocReqtTranslate) (*LocRespTranslate, error) {
...
func _LanguageService_Translate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LanguageServiceServer).Translate(ctx, req.(*LocReqtTranslate))
	}
...
var LanguageService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "locmod/loc_services.proto",
}
